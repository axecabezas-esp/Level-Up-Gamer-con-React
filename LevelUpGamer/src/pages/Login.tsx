  ...
  return (
    ...
    <div className="card-2 bg-dark text-light shadow-lg rounded-4 p-4 mx-auto" style={{maxWidth: '600px'}}>
      ...
      <form id="loginForm" className="needs-validation" noValidate>
        ...
        <div className="mt-3"> <p>¿No tienes una cuenta? <a className="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="Registro.html">Crea una cuenta</a></p></div>
